...
var I = (t, e, r) => e in t ? K(t, e, { enumerable: true, configurable: true, writable: true, value: r }) : t[e] = r;
var d = (t, e) => {
...
var re = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w.-]+)(?::(\d+))?\/(.+)/;
var N = "?";
var k = "An unknown error occurred";
var ne = "0.0.4";
function se(t) {
...
var he = "https://d233059272824702afc8c43834c4912d@sentry.hcaptcha.com/6";
var fe = "2.0.0";
var me = "production";
function j(t = true) {
  if (!t) return q();
...
var HCaptcha = function(_React$Component) {
  ...
  _proto.loadCaptcha = function loadCaptcha() {
    ...
    xe(mountParams).then(this.handleOnLoad, this.handleError)["catch"](this.handleError);
